COT-Recovery-sdcard-themes-jb-480x800-854-master
================================================

Themeing COT Recovery Easily - Read Me Belongs to original Developer of the Project COT Recovery 
...
<li>Please make sure all pull requests use the following format for branch names:</li>
	...
	* XX-RESxRES
	* Where XX is the recovery base; for example 'jb' for jelly bean.
